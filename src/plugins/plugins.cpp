            ...
            switch (plugin_id)
            {
                ...
                case PLUGIN_SYSCALLS:
                {
                    syscalls_config config =
                    {
                        ...
                        .syscalls_default_ret_cb = options->syscalls_default_ret_cb,
                        .syscalls_resolve_pid = options->syscalls_resolve_pid,
                    };
